...
class Scene(object):
    ...
    def enter(self):
        print("Эта сцена еще не настроена.\nСоздайте подкласс и реализуйте функцкию enter()")
        exit(1)
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        лаборатории, заложить её в топливном отсеке и покинуть
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        кнопками, и тебе надо ввеси правильный код, чтобы
        достать бомбу. Еслиты 10 раз введешь неправильный код,
        ...
        if guess == code:
            ...
            активировать её и успеть смотаться с корабля.
            """))
            return 'the_bridge'
        else:
            print(dedent("""
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            кнопку отстыковки. Капсулу вылетает в космическое
